...
public class NotesDatabaseHelper extends SQLiteOpenHelper {
    ...
    public void createPasswordTable(SQLiteDatabase db) {
        db.execSQL(CREATE_PASSWORD_TABLE_SQL);
        reCreatePasswordTriggers(db);
        Log.d(TAG, "password table has been created");
    }

    private void reCreatePasswordTriggers(SQLiteDatabase db) {
        // TODO:password表触发器
    }
    ...
    private void upgradeToV2(SQLiteDatabase db) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + TABLE.PASSWORD);
        createNoteTable(db);
        createDataTable(db);
        createPasswordTable(db);
    }
